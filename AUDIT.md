...
| P1 | post_maker | server.js AI endpoints | Dedicated AI endpoint rate limiting was missing. | Credentialed abuse can consume provider quota. | Added in-memory per-client rate limits for post generation, scripture suggestions, topic translation, and background generation. | Fixed |
